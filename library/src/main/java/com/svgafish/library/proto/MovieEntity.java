...
public final class MovieEntity extends Message<MovieEntity, MovieEntity.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "com.svgafish.library.proto.MovieParams#ADAPTER"
  )
  ...
  @WireField(
      tag = 4,
      adapter = "com.svgafish.library.proto.SpriteEntity#ADAPTER",
  ...
  @WireField(
      tag = 5,
      adapter = "com.svgafish.library.proto.AudioEntity#ADAPTER",
      label = WireField.Label.REPEATED
  )
